 ...
 * @author Pedro Igor
 */
public class QQIdentityProviderFactory extends AbstractIdentityProviderFactory<QQIdentityProvider> implements SocialIdentityProviderFactory<QQIdentityProvider> {
