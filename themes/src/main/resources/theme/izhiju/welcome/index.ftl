  ...
  <div class="row">
    <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
          ...
          <div class="card-pf h-l">
            ...
            <div class="welcome-primary-link">
              ...
              <div class="description">
                Centrally manage all aspects of the zhiju server
              </div>
            </div>
          </div>
        </div>
      ...
      <div class='footer'>
        ...
        <a href="https://www.izhiju.cn"><img src="welcome-content/keycloak_logo.png" alt="武汉智居科技"></a>
        </#if>
      </div>
    </div>
  </div>
